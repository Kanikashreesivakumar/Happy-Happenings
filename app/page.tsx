...
export default function HomePage() {
  ...
  const eventTypes = [
    ...
    },
    {
      ...
      description: "Memorable birthday celebrations tailored to your unique style",
      color: "bg-pink-100",
    ...
    },
    {
      ...
      description: "Romantic engagement parties that celebrate your love story",
      color: "bg-purple-100",
    ...
    },
    {
      ...
      description: "Sweet baby shower celebrations welcoming new arrivals",
      color: "bg-green-100",
    ...
    },
    {
      ...
      description: "Milestone anniversary celebrations honoring your journey",
      color: "bg-yellow-100",
  ...
  const features = [
    {
      ...
      description:
        "Every event is unique, and so are our custom-designed packages that reflect your personal style and vision.",
      icon: Heart,
    ...
    },
    {
      ...
      description:
        "Our experienced team of event planners brings years of expertise and countless successful events to your special day.",
      icon: Star,
