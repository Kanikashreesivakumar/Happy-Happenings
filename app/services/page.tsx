  ...
  const eventTypes = [
    {
      ...
      title: "Weddings",
      description: "Your ",
      image: "/pho.jpg?height=500&width=700&text=Elegant+Wedding+Ceremony",
      additionalImages: [
        "/s1.jpg?height=300&width=400&text=Wedding+Reception",
        "/s9.jpg?height=300&width=400&text=Bridal+Party",
        "/s5.jpg?height=300&width=400&text=Wedding+Cake",
      ],
      features: [
        "Venue Selection",
        "Bridal Styling",
    ...
    },
    {
      ...
      image: "/baby.jpg?height=500&width=700&text=Fun+Birthday+Party",
      additionalImages: [
        "/b4.jpg?height=300&width=400&text=Birthday+Decorations",
        "/b5.jpg?height=300&width=400&text=Birthday+Games",
        "/b6.jpg?height=300&width=400&text=Birthday+Cake",
      ],
      features: [
        "Theme Development",
        "Venue Decoration",
    ...
    },
    {
      ...
      image: "/enga.jpg?height=500&width=700&text=Romantic+Engagement+Party",
      additionalImages: [
        "/enga.jpg?height=300&width=400&text=Engagement+Decorations",
        "/enga.jpg?height=300&width=400&text=Engagement+Photos",
        "/enga.jpg?height=300&width=400&text=Engagement+Gifts",
      ],
      features: [
        "Romantic Settings",
        "Intimate Dining",
    ...
    },
    {
      ...
      image: "/wedd.jpg?height=500&width=700&text=Professional+Corporate+Event",
      additionalImages: [
        "/s2.jpg?height=300&width=400&text=Corporate+Networking",
        "/s7.jpg?height=300&width=400&text=Corporate+Presentation",
        "/s4.jpg?height=300&width=400&text=Corporate+Team",
      ],
      features: [
        "Conference Planning",
        "Team Building",
    ...
    },
    {
      ...
      image: "/b1.jpg?height=500&width=700&text=Cute+Baby+Shower",
      additionalImages: [
        "/b2.jpg?height=300&width=400&text=Baby+Shower+Decorations",
        "/b3.jpg?height=300&width=400&text=Baby+Shower+Games",
        "/b4.jpg?height=300&width=400&text=Baby+Shower+Gifts",
      ],
      features: [
        "Gender Reveal",
        "Themed Decorations",
    ...
    },
    {
      ...
      image: "/pro.jpg?height=500&width=700&text=Elegant+Anniversary+Party",
      additionalImages: [
        "/pro.jpg?height=300&width=400&text=Anniversary+Decorations",
        "/pro.jpg?height=300&width=400&text=Anniversary+Memories",
        "/pro.jpg?height=300&width=400&text=Anniversary+Cake",
      ],
      features: [
